...
var amount = unicorns.length
var loves = []

const total = unicorns.filter(element => {
  return element.loves.includes("apple")

})
console.log(total);

for (i = 0; i < amount; i++)
  unicorns.forEach(element => {
    if (element in loves === false)
      loves.push(element)
  });
...
// function listItems(unicorns) {
//   var amount = unicorns.length
//   var loves = []
//   for (i = 0; i < amount; i++)
//     loves.push(unicorns.loves)

//   document.getElementById('foodlist').innerHTML = loves
//   console.log(loves);
// }
// listItems(unicorns)